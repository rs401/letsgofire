...
const Terms = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Lets Go.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Lets Go, accessible from{" "}
            <a
              href="https://letsgo-325500.firebaseapp.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://letsgo-325500.firebaseapp.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: rich.stadnick@gmail.com</li>
      </ul>
    </div>
  );
};
